...
<body>
	...
	<div class="titre">
		<h1>Entrer modifications des statistiques</h1>
	</div>
  ...
  <?php
    ...
    if(file_exists($nomCsv)){
      ...
      echo("<form method='post' action='enregistrerModifStatistiques.php?nom=".$_POST["nom"]."&prenom=".$_POST["prenom"]."' class='formulaire'>
        <h4>Quelle ligne voulez vous modifier ?</h4>
        <div id='listeLignes'>
      ...
      header('Location: modifierStatistiques.php?ResearchError=true');
    }
  ?>
